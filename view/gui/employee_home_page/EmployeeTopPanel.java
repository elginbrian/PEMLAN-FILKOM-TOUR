...
public class EmployeeTopPanel extends JPanel {
    private JButton menuButton;
    private JButton profileButton;
    private JButton logoutButton;

    public EmployeeTopPanel(ActionListener menuActionListener, ActionListener logoutActionListener, ActionListener profileActionListener) {
